...
//           [notification.category]: deduplicateNotifications([notification, ...prev[notification.category]]).slice(0, notificationsPerPage),
//         };
//         notificationCache.delete(`all-${pagination.all.currentPage}`);
//         notificationCache.delete(`${notification.category}-${pagination[notification.category].currentPage}`);
//         console.log(`Updated notifications for ${notification.category}:`, updated[notification.category]);
//         return updated;
//       });
      ...
      <div className="flex items-center justify-between ml-8 mt-6">
        ...
        <div className="flex gap-2 mr-8">
          <button
            ...
            className="px-3 py-1 text-sm font-semibold bg-green-700 text-white rounded-lg border border-green-700 shadow hover:bg-green-900"
          >
            Mark All as Read
          </button>
          <button
            onClick={markAllAsUnread}
            className="px-3 py-1 text-sm font-semibold bg-green-60 text-green-800 rounded-lg border border-green-200 shadow hover:bg-green-200"
          >
            Mark All as Unread
          </button>
          <button
...
//one button for mark as read unread
// import React, { useEffect, useState, useCallback, useMemo, useRef } from 'react';
// import { useNavigate } from 'react-router-dom';
// import { io } from 'socket.io-client';
// import { debounce } from 'lodash';
...
//   // Determine if all notifications in the current filter are read
//   useEffect(() => {
