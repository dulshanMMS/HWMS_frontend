...
const LightCTASection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-green-50 via-green-100 to-emerald-50 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-green-300 rounded-full opacity-15 blur-lg"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className={`transform transition-all duration-1000 ease-out ${
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-green-600"> smarter workplace</span>
          </h2>
        </div>
