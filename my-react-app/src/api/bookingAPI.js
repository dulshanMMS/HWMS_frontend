export const getBookings = async () => {
  ...
  if (data.chairs) {
    Object.keys(data.chairs).forEach((chairId) => {
      ...
      // UPDATED: Check for userName instead of memberName
...
export const bookSeat = async (chairId, bookingDetails) => {
  ...
  // UPDATED: Use userName instead of memberName in the request body
  const body = { roomId, teamName, teamColor, userName, memberName };
